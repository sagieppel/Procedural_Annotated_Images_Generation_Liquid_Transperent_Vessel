...
####################################################################################################################
def AddVessel(VesselName="Vessel",ContentName="MaterialContent",MinH=10,MaxH=60,MinR=5,MaxR=60,add_liquid = False):   
...
OutFolder="/home/helen/Documents/projects/Procedural_Annotated_Images_Generation_Liquid_Transperent_Vessel/out/"# Where output images will be saved
HDRI_BackGroundFolder="/home/helen/Documents/projects/Procedural_Annotated_Images_Generation_Liquid_Transperent_Vessel/HDRI_BackGround//" # Background dri folder
PBRMaterialsFolder="/home/helen/Documents/projects/Procedural_Annotated_Images_Generation_Liquid_Transperent_Vessel/PBRMaterials/" #folder of pbr materials
...
for cnt in range(10000000000000):
    ...
    AddBackground(HDRI_BackGroundFolder) # Add random Background hdri from hdri folder
    '''
    ...
    #RenderImageAndSave(FileNamePrefix="Vessel",FramesToRender=[20,50,80],OutputFolder=OutputFolder) # Render images and Save
    RenderImageAndSave(FileNamePrefix="Vessel",FramesToRender=[20],OutputFolder=OutputFolder)
    '''
    ...
    '''
    #f=open(OutputFolder+"/Finish.txt","w")
