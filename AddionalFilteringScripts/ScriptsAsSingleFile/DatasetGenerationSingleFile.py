...
## Description:
# This script will procedurally generate images of randomly shaped transparent vessels with random objects or simulated liquid inside the vessel, all functions ares supplied in this file). 
...
#### This was run with Blender 3 with no additional add-ons
...
#    #------------------------------Create random vessel object and assign  material to it---------------------------------
    MaxXY,MaxZ,MinZ,VesselWallThikness=AddVessel("Vessel","Content",ScaleFactor=1, SimpleLiquid=(ContentMode=="FlatLiquid")) # Create Vessel object named "Vessel" and add to scene also create mesh inside the vessel ("Content) which will be transformed to liquid
...
#....................Delete uneeded parts---------------------------------------------------------------------
    if ContentMode!="FlatLiquid": DeleteObject("Content") # Delete the liquid  object (The liquid that was generated in the simulation is attached to the LiquidDomain and will not be effected, if you use simple liquid the Content is the liquid and will not be deleted
