#Description: This script will procedurally generate images of randomly shaped  transparent vessel with simulated liquid of random material, and random background and object scatter around 
...
#What needed:  Objects Folder,  HDRI background folder and a folder  of PBR materials (Example folders are available with this  script folder as: HDRI_BackGround, PBRMaterials

# What to do: Go to “main” (Line 1420) section in the end of this file, in “input parameter” subsection
...
# 6) This was on ubuntu 20 with blender 2.92
...
# ======================Apply random rotation======================
    for i in range(3):
       bpy.context.object.rotation_quaternion[2] =np.random.rand()*6.2831853
...
def LoadNObjectsToScene(ObjectList,AvoidPos,AvoidRad,NumObjects,MnPos,MxPos,MnScale,MxScale):
    print("==================Set "+print(NumObjects)+" objects in given region in image in radnom scale and postions=================")
...
###################################################################################################################################################################
#  Main loop generate scence with random vessel containing either a fluid or an object inside it and save to file
...
HDRI_BackGroundFolder=r"/home/breakeroftime/Documents/Datasets/DataForVirtualDataSet/4k_HDRI/4k/" # Background Hdri folder
PBRMaterialsFolder=r"/home/breakeroftime/Documents/Datasets/DataForVirtualDataSet/2K_PBR/" #PBR materials folder
...
OutFolder=r"/home/breakeroftime/Documents/Datasets/DataForVirtualDataSet/OutObjectSupported/"# Where output images will be saved

LiquidContentFractionOfCases=0.4 # Fraction of images that will be generated with liquid simulation inside the vessel, the rest will be created with objects inside the vessel
...
bpy.context.scene.cycles.samples = 200 #120, #900 # This work well for rtx 3090 for weaker hardware this can take lots of time
